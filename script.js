...
hitpoints.innerHTML--;
hitpoints.innerHTML--;}      
else if (move3.innerHTML == count2.innerHTML && count.innerHTML == "6") {
hitpoints.innerHTML--;
hitpoints.innerHTML--;
hitpoints.innerHTML--;
hitpoints.innerHTML--;
...
hitpoints.innerHTML--;
hitpoints.innerHTML--;}     
else if (move4.innerHTML == count2.innerHTML && count.innerHTML == "9") {
hitpoints.innerHTML--;
hitpoints.innerHTML--;
hitpoints.innerHTML--;
hitpoints.innerHTML--;
...
hitpoints.innerHTML--;
hitpoints.innerHTML--;} 
 else if (move5.innerHTML == count2.innerHTML && count.innerHTML == "12") {
hitpoints.innerHTML--;
hitpoints.innerHTML--;
hitpoints.innerHTML--;
hitpoints.innerHTML--;
...
function myFuncFire() {
switch(true) {
    case ballCount.innerHTML != birdCount.innerHTML && count.innerHTML != "0":    
